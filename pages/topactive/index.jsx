...
import TopActiveCard from '../../components/TopActiveCard'
...
export default function Home() {
    ...
    return (
        <div >
            <Head>
                <title>ALL TOP ACTIVE TICKERS || Humble Titan</title>
            ...
            <Layout>
                <div className="pt-5_abcd pb-5_abcd">
                    <h1 className='pb-5_abcd abcd_row abcd_justify-center blue-color_abcd f-60_abcd text-transform_abcd'>Top Active</h1>
                    <div className="abcd_container">
                        <div className="abcd_row keyvaluecards_abcd abcd_justify-betwee n  row_wraper_abcd">
                            {allcompany && allcompany?.map((data, kay) =>
                                data?.Info?.companyname && <TopActiveCard data={data} key={kay} />
