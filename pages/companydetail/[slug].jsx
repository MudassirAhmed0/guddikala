...
const CompantDetail = ({
  ...
  const profile = companyProfile?.Item?.Info
  const shares = companyShares?.Item?.Info
  const financial = comapnyFinancialRatio?.Item?.Info
  const keymatrics = comapnyKeymetrics?.Item?.Info
  const rating = comapnyRating?.Item?.Info
  const competitors = competitorsData
  const realtimequotes = comapnyRealTimeQuote?.Item?.Info
  const financialgrowth = comapnyFinancialGrowth?.Item?.Info
    ...
    cards: [
      {
        ...
        listItems: [
          ['Previous Close', keymatrics?.researchanddevelopementtorevenuettm ? keymatrics?.researchanddevelopementtorevenuettm : 'NA'],
          ['Day Open', keymatrics?.researchanddevelopementtorevenuettm ? keymatrics?.researchanddevelopementtorevenuettm : 'NA'],
          ['Day Change', keymatrics?.intangiblestototalassetsttm ? keymatrics?.intangiblestototalassetsttm : 'NA'],
          ['% Day Change', keymatrics?.capextooperatingcashflowttm ? keymatrics?.capextooperatingcashflowttm : 'NA'],
          ['Day Low', keymatrics?.capextorevenuettm ? keymatrics?.capextorevenuettm : 'NA'],
          ['Day High', keymatrics?.capextodepreciationttm ? keymatrics?.capextodepreciationttm : 'NA'],
          ['Volume', keymatrics?.stockbasedcompensationtorevenuettm ? keymatrics?.stockbasedcompensationtorevenuettm : 'NA']
        ]
      },
      {
        ...
        listItems: [
          ['Year Low', keymatrics?.freecashflowyieldttm ? keymatrics?.freecashflowyieldttm : 'NA'],
          ['Year High', keymatrics?.incomequalityttm ? keymatrics?.incomequalityttm : 'NA'],
          ['50 Day Avg.', keymatrics?.returnontangibleassetsttm ? keymatrics?.returnontangibleassetsttm : 'NA'],
          ['200 Day Avg.', keymatrics?.grahamnetnetttm ? keymatrics?.grahamnetnetttm : 'NA'],
          ['% of Year High', keymatrics?.netcurrentassetvaluettm ? keymatrics?.netcurrentassetvaluettm : 'NA'],
          ['% of Year Low', keymatrics?.investedcapitalttm ? keymatrics?.investedcapitalttm : 'NA'],
          ['Average Volume', keymatrics?.dayssalesoutstandingttm ? keymatrics?.dayssalesoutstandingttm : 'NA']
        ]
      }
  ...
  <div>
    <Head>
      <title>ABCD Stock - Humble Titan</title>
      <meta name="description" content="Generated by create next app" />

    </Head>
    <Layout>
      {/* <Tickerslider /> */}
      <Company profile={profile} shares={shares} />
