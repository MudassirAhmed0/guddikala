    ...
    return (
        <>
            ...
            {customPages?.map(item=>
                <div className="abcd_row abcd_justify-center abcd_wrap mb-2_abcd">
                        ...
                        <div className="keyvaluecard_abcd p-1_abcd">
                            ...
                            <div className='abcd_row abcd_justify-between p-1_abcd abcd_wrap'>
                                ...
                                <div className='abcd_col-4 custom-card-full-width'>
                                    ...
                                    {/* <span className='customcard-border_abcd'></span>
                                    <span className='customcard-border-bottom_abcd'></span> */}
                                    </div>
                                </div>
                                <div className='abcd_col-4 custom-card-full-width'>
                                    <h2 className='text-center_abcd'>Company Description</h2>
                                    <div>
                                        <p className='customcard-para'>{item[1]?.description}</p>
                                    </div>
                                </div>
                            </div>
                            <button className="profile_card_btn_abcd bluehai-btn mb-1_abcd">
